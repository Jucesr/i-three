...
const config = {
  ...
  forge: {
    ...
    viewer: {
      viewer3D: 'https://developer.api.autodesk.com/derivativeservice/v2/viewers/viewer3D.js', //3.3
      threeJS:  'https://developer.api.autodesk.com/derivativeservice/v2/viewers/three.js',
